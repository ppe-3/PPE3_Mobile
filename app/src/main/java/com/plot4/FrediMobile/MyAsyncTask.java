...
public class MyAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    public static final String EXTRA_MESSAGE = "com.plot4.FrediMobile.MESSAGE";


    String MyURL = "http://192.168.150.61:80/PPE_3_V2/json.php";
    String MyUser = "";
    String MyPassword = "";
    ListView myListView;
    Context myContext;
    ...
    protected String doInBackground(Void... voids) {
        //http://localhost/PPE_3_V2/json.php?user=c.puel@t.fr&password=test
